...
class Object:
    def __init__(self, object_type):
        ...
        self.color = OBJECT_COLORS[object_type]
...
for i in range(SPACE_SIZE * 3):
    ...
    space.add_object(x, y, Object("food"))

# fill creatures
for i in range(SPACE_SIZE // 10):
    x, y = space.get_vacant_position()
    space.add_object(x, y, Object("creature"))
...
for day in range(N_DAYS):
    ...
    print(space.cnt_creatures, space.cnt_food)
